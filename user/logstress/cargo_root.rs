//! Cargo entry point for the `logstress` user binary. This wrapper just
//! re-roots the existing source files (`../logstress.rs` plus the four
...
#[path = "../logstress.rs"] pub mod prog;
